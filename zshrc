...
plugins=(ubuntu python autojump history history-substring-search vim-interaction debian encode64 python git git-extras pip sudo docker bower mvn node npm vagrant golang github jump mvn sysadmin zsh_reload tmux colored-man zsh-syntax-highlighting k grunt)
